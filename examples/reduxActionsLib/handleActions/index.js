...
/// Reducer
///////////////////////////////////////////////////////
var reducer = ReduxActions.handleActions({
    [INC]: (state, action) => Object.assign({}, state, {counter: state.counter + 1}),
    [DEC]: (state, action) => Object.assign({}, state, {counter: state.counter - 1}),
    [MULTIPLY]: (state, action) => Object.assign({}, state, {counter: state.counter * action.payload}),
    [SET_ERROR]: (state, action) => Object.assign({}, state, {error: action.payload})
}, initialState);
